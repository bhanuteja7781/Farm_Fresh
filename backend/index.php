...
switch($route){
        ...
        case 'api/getuser':
            ...
            break;
        case 'api/profile':
            require 'api/auth/profile.php';
            break;
        case 'api/profile/update':
            require 'api/auth/updateprofile.php';
            break;
        case 'api/products/upload':
            require 'api/products/upload.php';
            break;
        ...
        case 'api/orders/updatestatus':
            ...
            break;
        case 'api/orders/verifydelivery':
            require 'api/orders/verifydelivery.php';
            break;
